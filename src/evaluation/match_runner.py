...
Phase: Phase 5
Purpose: Generic N-match evaluation harness, reused across Phase 5a/5b/5c.
...
def _not_implemented(*args, **kwargs):
    raise NotImplementedError(
        "src.evaluation.match_runner is scaffolded in Phase 0; implementation lands in Phase 5."
    )

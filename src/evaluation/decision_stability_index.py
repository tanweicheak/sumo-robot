"""
src.evaluation.decision_stability_index

Phase: Phase 5
Purpose: Phase 5c: variance in TEA motor-command output, real noisy input vs. clean simulated input.
...
def _not_implemented(*args, **kwargs):
    raise NotImplementedError(
        "src.evaluation.decision_stability_index is scaffolded in Phase 0; implementation lands in Phase 5."
    )

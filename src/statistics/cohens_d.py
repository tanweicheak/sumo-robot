...
Phase: Phase 5
Purpose: Cohen's d for continuous metrics, plus Cohen's h (proportion variant) for win-rate secondary reporting. See plan Assumption A4.
...
def _not_implemented(*args, **kwargs):
    raise NotImplementedError(
        "src.statistics.cohens_d is scaffolded in Phase 0; implementation lands in Phase 5."
    )

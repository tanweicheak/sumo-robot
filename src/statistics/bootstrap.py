...
Phase: Phase 5
Purpose: Bootstrap resampling for confidence intervals (latency, Phase 5c continuous metrics).
...
def _not_implemented(*args, **kwargs):
    raise NotImplementedError(
        "src.statistics.bootstrap is scaffolded in Phase 0; implementation lands in Phase 5."
    )
